...
def add_widgets():
    ...
    if uploaded_file is not None:
        ...
        st.write("#### :leaves: Luca Height and Branch")
        with st.container():
        ...
        ################################################################     
        st.divider()
        st.write("#### :leaves: Check the generated xml below and then save it when happy")        
        ################################################################                                                          
